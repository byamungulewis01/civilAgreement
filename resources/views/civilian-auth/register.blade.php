    ...
    <div class="authentication-inner row">
      ...
      <div class="d-flex col-12 col-lg-6 align-items-center p-sm-5 p-4">
        <div class="w-px-700 mx-auto">
          ...
          <form id="formAuthentication" class="mb-3 fv-plugins-bootstrap5 fv-plugins-framework" action="" method="POST" novalidate="novalidate" enctype="multipart/form-data">
            @csrf
            @if($errors->any())
             ...
             <div class="row">
                ...
                <div class="col-md-6 mb-3 fv-plugins-icon-container">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="phone" name="phone" class="form-control" placeholder="Phone number" minlength="9" maxlength="9">
                      </div>

                    {{-- <input type="text" class="form-control" id="phone" name="phone" placeholder="Enter your phone" minlength="10" maxlength="10"> --}}
                  <div class="fv-plugins-message-container invalid-feedback"></div></div>
             </div>
             <div class="row">
                <div class="col-md-6 mb-3 fv-plugins-icon-container">
                    <label for="national_id" class="form-label">National ID</label>
                    <input type="text" class="form-control" id="national_id" name="national_id" placeholder="Enter your ID Number" minlength="16" maxlength="16">
                  <div class="fv-plugins-message-container invalid-feedback"></div></div>
                <div class="col-md-6 mb-3 fv-plugins-icon-container">

                    <label for="national_id_image" class="form-label">National ID Image</label>
                    <input class="form-control" type="file" id="national_id_image" name="national_id_image" accept="image/*">
                  <div class="fv-plugins-message-container invalid-feedback"></div></div>
             </div>
