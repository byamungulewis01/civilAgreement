                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3 fv-plugins-icon-container">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('national_id') }}"
                                            id="national_id" name="national_id" required placeholder="Enter your ID Number"
                                ...
                                <div class="mb-3 fv-plugins-icon-container">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="phone" name="phone" value="{{ old('phone') }}"
                                            required class="form-control" placeholder="Phone number" minlength="10"
                                            maxlength="10">
                                    </div>
                                </div>
                                <div class="mb-3 fv-plugins-icon-container">
                    ...
                    @foreach ($civilians as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="modal fade" id="editCivilian{{ $item->id }}" tabindex="-1"
                                    aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered1 modal-simple modal-add-new-cc">
                                        <div class="modal-content p-3 p-md-5">
                                            <div class="modal-body">
                                                ...
                                                <form id="formAuthentication"
                                                    ...
                                                    action="{{ route('admin.civilian.update', $item->id) }}"
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-md-6 fv-plugins-icon-container">
                                                            ...
                                                            <label for="national_id" class="form-label">National
                                                                ID</label>
                                                            <input type="text" class="form-control" id="national_id"
                                                                name="national_id"
                                                                value="{{ old('national_id', $item->national_id) }}"
                                                                minlength="16" maxlength="16">
                                                        ...
                                                        <div class="col-md-6 fv-plugins-icon-container">
                                                            ...
                                                            <select name="status" class="form-select" id="">
                                                                ...
                                                                <option
                                                                    {{ old('status', $item->status) == 2 ? 'selected' : '' }}
                                                    ...
                                                    <div class="mb-3 fv-plugins-icon-container">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="phone" name="phone" required
                                                                class="form-control"
                                                                value="{{ old('phone', $item->phone) }}" minlength="10"
                                                                maxlength="10">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3 fv-plugins-icon-container">
                                ...
                                <div class="modal fade" id="deleteCivilian{{ $item->id }}" tabindex="-1"
                                    aria-hidden="true">
                                    <div class="modal-dialog modal-sm" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('admin.civilian.destroy', $item->id) }}"
                                                method="post">
                                                @csrf
                                                @method('DELETE')
                                                <div class="modal-body">
                                ...
                                <div class="modal fade" id="activate{{ $item->id }}" tabindex="-1"
                                    aria-hidden="true">
                                    <div class="modal-dialog modal-sm" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <form action="{{ route('admin.civilian.activate', $item->id) }}"
                                                method="post">
                                                @csrf
                                                @method('PUT')
                                                <div class="modal-body">
                                                    ...
                                                    <div class="text-center mb-1">
                                                        ...
                                                        <p class="text-muted">You Are About to Active a civilian to be
                                                            active</p>
                                                    </div>
                                                    <div class="text-end">
                                                        <button type="button" class="btn btn-label-secondary"
