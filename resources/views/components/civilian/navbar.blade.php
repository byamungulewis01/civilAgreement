...
<div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
    ...
    <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <!-- Notification -->
        @php
          $agreements = \App\Models\Agreement::where('partyTwo', auth()->guard('civilian')->user()->id)->where('status','pending')->orderBy('id', 'desc')->get();
        @endphp
                        ...
                        <li class="list-group-item list-group-item-action dropdown-notifications-item">
                            <div class="d-flex">
                                <div class="flex-shrink-0 me-3">
                                    ...
                                    <div class="avatar">
                                        <span
                                            class="avatar-initial rounded-circle bg-label-danger">{{ $initials }}</span>
                                    </div>
                                </div>
                ...
                <li>
                    <a class="dropdown-item" href="{{ route('civilian.dash.profile') }}">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                <span class="fw-semibold d-block">{{ auth()->guard('civilian')->user()->name }}</span>
